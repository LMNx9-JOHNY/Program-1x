...
# \x1b[38;5;200m  [Deep] beguni
# \x1b[38;5;213m  [Blur] beguni
# \x1b[38;5;202m  [Deep] orange 
# \x1b[38;5;208m  [Blur] orange 
logo = ("""\x1b[38;5;200m
...
os.system("xdg-open https://www.facebook.com/profile.php?id=100083728231426&mibextid=ZbWKwL")
# \x1b[38;5;200m  [Deep] beguni
# \x1b[38;5;213m  [Blur] beguni
# \x1b[38;5;202m  [Deep] orange 
# \x1b[38;5;208m  [Blur] orange 
#print(logo)
os.system("espeak -a 300\" What's, Your, Real, Name\"")
name = input(f'\x1b[38;5;200m╰─⌥⌣❥\x1b[38;5;202m𝐘𝐎𝐔𝐑 𝐍𝐀𝐌𝐄 \x1b[38;5;200m❥⌥⌣⎇ \x1b[38;5;202m')
os.system("xdg-open https://t.me/+zEnz6yog9AxlNzc9")
...
def GF():
	...
	wel=f'#\x1b[38;5;200m ❥⌥⌣⎇ \x1b[38;5;202m{name} \x1b[38;5;200m𝐘𝐎𝐔𝐑 \x1b[38;5;202m𝐆𝐈𝐑𝐋𝐅𝐑𝐈𝐄𝐍𝐃\x1b[38;5;200m 𝐈𝐃 𝐋𝐈𝐍𝐊 \x1b[38;5;202m❥⌥⌣⎇ '
print("⳹🥰💏🥰⳼")
print(f'\x1b[38;5;202m❥⌥⌣⎇\x1b[38;5;200m{name}\x1b[38;5;202m 𝐘𝐨𝐮𝐫 𝐆𝐢𝐫𝐥𝐅𝐫𝐢𝐞𝐧𝐝 𝐈𝐝 😍 -\n \x1b[38;5;200m❥⌥⌣⎇ \x1b[38;5;202m{GIRL}')

print(" ")
	
print("𝐅𝐢𝐧𝐝 𝐌𝐨𝐫𝐞 𝐆𝐈𝐑𝐋𝐅𝐑𝐈𝐄𝐍𝐃 ??? [𝐲/𝐧] ")
more = input("𝐂𝐇𝐎𝐎𝐒𝐄⌥⌣⎇❥ ")
if more in ["y","Y"]:
		os.system("python gflmn.py")
if more in ["n","N"]:
		print("𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐞 𝐋𝐌𝐍𝐱𝟗 𝐓𝐨𝐨𝐥")
		exit()
...
def BF():
	...
	wel=f'#\x1b[38;5;200m ❥⌥⌣⎇ \x1b[38;5;202m{name} \x1b[38;5;200m𝐘𝐎𝐔𝐑 \x1b[38;5;202m𝐁𝐎𝐘𝐅𝐑𝐈𝐄𝐍𝐃\x1b[38;5;200m 𝐈𝐃 𝐋𝐈𝐍𝐊 \x1b[38;5;202m❥⌥⌣⎇ '
	print(" ⳹🥰💏🥰⳼")
	print(f'\x1b[38;5;202m❥⌥⌣⎇\x1b[38;5;200m{name}\x1b[38;5;202m 𝐘𝐨𝐮𝐫 𝐁𝐨𝐲𝐅𝐫𝐢𝐞𝐧𝐝 𝐈𝐝 😍 -\n \x1b[38;5;200m❥⌥⌣⎇ \x1b[38;5;202m{BOY}')
	print(" ")
	
	print("𝐅𝐢𝐧𝐝 𝐌𝐨𝐫𝐞 𝐁𝐎𝐘𝐅𝐑𝐈𝐄𝐍𝐃 ??? [𝐲/𝐧] ")
	more = input("𝐂𝐇𝐎𝐎𝐒𝐄⌥⌣⎇❥ ")
	if more in ["y","Y"]:
		os.system("python gflmn.py")
	if more in ["n","N"]:
...
'https://www.facebook.com/LJ.LMNx9',
...
class Main:
		...
		print(logo)
		print (f'\033[1;36m❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥')
		print (f'\033[1;36m ❥[𝟏] [A] 𝐅𝐢𝐧𝐝 𝐘𝐨𝐮𝐫 𝐆𝐈𝐑𝐋𝐅𝐑𝐈𝐄𝐍𝐃')

		print (f'\033[1;36m ❥[𝟐] [B] 𝐅𝐢𝐧𝐝 𝐘𝐨𝐮𝐫 𝐁𝐎𝐘𝐅𝐑𝐈𝐄𝐍𝐃')
		print (f'\033[1;36m❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥')
		print (f'\033[1;36m ❥[𝟑] [C] 𝐀𝐃𝐌𝐈𝐍 𝐎𝐧 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊')
		print (f'\033[1;36m ❥[𝟒] [C] 𝐀𝐃𝐌𝐈𝐍 𝐎𝐧 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝟐')
		print (f'\033[1;36m ❥[𝟓] [C] 𝐀𝐃𝐌𝐈𝐍 𝐎𝐧 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌')
		print (f'\033[1;36m❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥⌥⌣⎇❥')
		print (f'\033[1;36m ❥[𝟔] [D] 𝐄𝐱𝐢𝐭 𝐓𝐨𝐨𝐥\n')

		limon = input(f'\033[1;36m 𝐂𝐇𝐎𝐎𝐒𝐄⌥⌣⎇❥ ')
		...
		if limon in ["04","4"]:
			os.system("xdg-open https://www.facebook.com/lmnx9.johny")
		if limon in ["05","5"]:
			os.system("xdg-open https://t.me/+zEnz6yog9AxlNzc9")
		if limon in ["06","6"]:
